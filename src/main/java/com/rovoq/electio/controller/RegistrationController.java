...
public class RegistrationController {
    ...
    @Value("${recaptcha.secret}")//Получение параметра из файла properties
    ...
    public String addUser(@RequestParam("password2") String passwordConfirm,
        ...
        if (isConfirmEmpty) {
            model.addAttribute("password2Error", "Password confirmation cannon be empty");
        }
        ...
        if (isConfirmEmpty || bindingResult.hasErrors() || !response.isSuccess()) {//Если есть ошибки компиляции
