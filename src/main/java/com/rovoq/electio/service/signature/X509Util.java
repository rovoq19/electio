...
public class X509Util
{
     ...
     */
    static X509Util.Implementation getImplementation(
            String      baseName,
            String      algorithm,
            Provider    prov)
            throws NoSuchAlgorithmException
    {
        ...
        if (className != null)
        {
            try
            {
                ...
                return new X509Util.Implementation(cls.newInstance(), prov);
            }
            ...
            throws NoSuchAlgorithmException
    {
        ...
        for (int i = 0; i != prov.length; i++)
        {
            ...
            //
            X509Util.Implementation imp = getImplementation(baseName, Strings.toUpperCase(algorithm), prov[i]);
            if (imp != null)
            {
                return imp;
            }
